<template>
	<view class="uni-date">
		<view class="uni-date-editor" style="opacity: 0;" @click="show">
			<slot>
		...
		'uni-date-x--border': border}">
					...
					<view
						...
						<uni-icons v-show="false" type="clear" color="#e1e1e1" size="14"></uni-icons>
					</view>
				</view>
			</slot>
		</view>
...
<script>
	...
	export default {
		...
		methods: {
			...
			leftMonthSwitch(e) {
				// // ('leftMonthSwitch 返回:', e)
			},
			rightMonthSwitch(e) {
				// // ('rightMonthSwitch 返回:', e)
			}
		}
	}
</script>
